...
public class ClientSimpleScanner extends ClientScanner {
  ...
  public ClientSimpleScanner(Configuration configuration, Scan scan, TableName name,
      ...
      RpcControllerFactory rpcControllerFactory) throws IOException {
    super(configuration, scan, name, connection, rpcCallerFactory, rpcControllerFactory);
  }

  public ClientSimpleScanner(Configuration conf, Scan scan, TableName tableName,
