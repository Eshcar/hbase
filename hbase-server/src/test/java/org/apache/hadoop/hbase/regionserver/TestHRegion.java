...
public class TestHRegion {
  ...
  class GetTillDoneOrException extends Thread {
    ...
    GetTillDoneOrException(final int i, final byte[] r, final AtomicBoolean d, final
    AtomicInteger c) {
      super("getter." + i);
      this.g = new Get(r);
      this.done = d;
  ...
  public void testGetScanner_WithRegionClosed() throws IOException {
    ...
    try {
      ...
      try {
        ...
        fail("Got wrong type of exception - should be a NotServingRegionException, but was an "
            + "IOException: "
            + e.getMessage());
      }
    } finally {
