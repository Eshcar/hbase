...
public class TestHRegion {
  ...
  public void testSkipRecoveredEditsReplay() throws Exception {
    ...
    try {
      ...
      long seqId = region.replayRecoveredEditsIfAny(regiondir, maxSeqIdInStores, null, status, null);
  ...
  public void testSkipRecoveredEditsReplayAllIgnored() throws Exception {
    ...
    try {
      ...
      long seqId = region.replayRecoveredEditsIfAny(regiondir, maxSeqIdInStores, null, null, null);
