...
public class TestStore {
  ...
  private void flush(int storeFilessize) throws IOException{
    ...
    Assert.assertEquals(0, ((DefaultMemStore)this.store.memstore).getCellSet().size());
  }
  ...
  public void testIncrementColumnValue_ICVDuringFlush()
    ...
    Assert.assertEquals(2, ((DefaultMemStore)this.store.memstore).getCellSet().size());
  ...
  public void testICV_negMemstoreSize()  throws IOException {
    ...
    long computedSize=0;
    for (Cell cell : ((DefaultMemStore)this.store.memstore).getCellSet().getCellSet()) {
  ...
  public void testIncrementColumnValue_SnapshotFlushCombo() throws Exception {
    ...
    flushStore(store, id++);
    Assert.assertEquals(1, this.store.getStorefiles().size());
    Assert.assertEquals(1, ((DefaultMemStore)this.store.memstore).getCellSet().size());
