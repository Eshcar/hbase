...
class CellSetMgr {
  ...
  private CellSetMgr(CellSet cellSet, MemStoreLAB memStoreLAB, KeyValue.KVComparator comparator) {
    this.cellSet = cellSet;
    this.memStoreLAB = memStoreLAB;
    this.comparator = comparator;
  }
  private CellSetMgr(CellSet cellSet, KeyValue.KVComparator comparator) {
    this(cellSet,null, comparator);
  }
  ...
  public int getReferenceCount(){
    if (this.memStoreLAB != null) {
      return memStoreLAB.getScannerCount();
    }
    return -1;
  }
  ...
  static class Factory {
    ...
    private CellSetMgr generateCellSetMgrByType(Type type,
      ...
      default:
        obj = new CellSetMgr(set, memStoreLAB, comparator);
      }
      return obj;
    }
