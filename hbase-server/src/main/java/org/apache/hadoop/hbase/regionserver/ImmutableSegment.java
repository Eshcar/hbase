...
public class ImmutableSegment extends Segment {
   ...
   */
  protected ImmutableSegment(CellComparator comparator, SegmentsIterator iterator,
  ...
  private CellSet createCellArrayMapSet(int numOfCells, SegmentsIterator iterator,
      boolean merge) {
