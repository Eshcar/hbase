...
public class DefaultMemStore implements MemStore {
  ...
  public DefaultMemStore(final Configuration conf,
    ...
    this.cellSet = CellSetMgr.Factory.instance().createCellSetMgr(
        CellSetMgr.Type.READ_WRITE, conf,c);
  ...
  public MemStoreSnapshot snapshot() {
    ...
    if (!this.snapshot.isEmpty()) {
      ...
      if (!this.cellSet.isEmpty()) {
        ...
        this.cellSet = CellSetMgr.Factory.instance().createCellSetMgr(CellSetMgr.Type.READ_WRITE,
            conf, this.comparator);
  ...
  public void clearSnapshot(long id) throws UnexpectedStateException {
    ...
    if (!this.snapshot.isEmpty()) {
      this.snapshot.close();
      this.snapshot = CellSetMgr.Factory.instance().createCellSetMgr(
          CellSetMgr.Type.EMPTY_SNAPSHOT, this.comparator);
