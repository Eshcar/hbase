...
//    if(currentIdx > 1000) {
//      String s = "<< Iteration: " + currentIdx + ", Size: " + cellSetMgr.size() +
//              ", Cell count: " + cellSetMgr.getCellSet().size() +
//              ", Current cell: " + current.toString() + " >";
//      throw new AssertionError("\nNext of CellSetScanner called:\n" + s);
//    }
  ...
  public int reportReferenceCount(){  //debug method
    return cellSetMgr.getMemStoreLAB().getScannerCount();
  }
   ...
   *
   * This scanner is always doing the real seek
   */
