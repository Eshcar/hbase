...
module Hbase
  class Admin
    ...
    def hcd(arg, htd)
      ...
      family.setCompacted(JBoolean.valueOf(arg.delete(org.apache.hadoop.hbase.HColumnDescriptor::COMPACTED))) if arg.include?(org.apache.hadoop.hbase.HColumnDescriptor::COMPACTED)
