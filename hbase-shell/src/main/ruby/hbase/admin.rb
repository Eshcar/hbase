...
module Hbase
  class Admin
    ...
    def hcd(arg, htd)
      ...
      family.setMemStoreClass(arg.delete(org.apache.hadoop.hbase.HColumnDescriptor::MEMSTORE_CLASS_NAME)) if arg.include?(org.apache.hadoop.hbase.HColumnDescriptor::MEMSTORE_CLASS_NAME)
